...
int main(int argc, char* argv[])
{
    ...
    case UPLOAD_OPT: { // for upload operation
        ...
        // update the log
        double speed = static_cast<double>(chunkerObj->_recipe.recipeHead.fileSize) / 1024.0 / 1024.0 / totalTime;
    ...
    case DOWNLOAD_OPT: {
        ...
        // update the log
        double speed = static_cast<double>(dataRetrieverObj->_totalRecvDataSize) / 1024.0 / 1024.0 / totalTime;
